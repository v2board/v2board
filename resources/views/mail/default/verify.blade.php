                ...
                <div style="background:#fff">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="padding:40px 40px 0 40px;display:table-cell">
                            <td style="font-size:24px;line-height:1.5;color:#000;margin-top:40px">E-mail verification code</td>
                        </tr>
                        <tr>
                            ...
                            Hello, Dear User!
                                <br />
                                <br />
                                Your verification code is: {{$code}}, please verify within 5 minutes. If this verification code is not for your own application, please ignore it.
                            </td>
                        </tr>
