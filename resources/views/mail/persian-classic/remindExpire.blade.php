...
<head>
    <meta charset="UTF-8">
    <title> هشدار اشتراک شما رو به اتمام است </title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                    ...
                    <table class="main" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr
                            ...
                            <td class="alert alert-warning"
                                ...
                                هشدار اشتراک شما رو به اتمام است
                            </td>
                        </tr>
                        <tr
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            اشتراک شما <strong>24</strong> ساعت دیگر منقضی می‌شود، لطفا در اسرع وقت اشتراک خود را تمدید کنید تا در استفاده شما اختلال ایجاد نشود. اگر قبلا اشتراک خود را تمدید کرده اید، لطفاً این ایمیل را نادیده بگیرید.
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            (این ایمیل به صورت خودکار توسط سیستم ارسال می شود، لطفا به آن پاسخ ندهید)
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        ...
                        <table width="100%"
                            ...
                            <tr
                                ...
                                <td class="aligncenter content-block"
                                    ...
                                    &copy; {{$name}}. تمامی حقوق  این سایت محفوظ است.
                                </td>
                            </tr>
                            <tr
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                <td class="aligncenter content-block"
                                    ...
                                    <a href="{{$url}}/#/subscribe"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: none; margin: 0;">اشتراک های من</a> |
                                    <a href="{{$url}}/#/knowledge"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: none; margin: 0;">آموزش ها</a>
                                </td>
                            </tr>
                        </table>
                    </div>
