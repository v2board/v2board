...
<head>
    <meta charset="UTF-8">
    <title> هشدار ترافیک شما رو به اتمام است </title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                    ...
                    <table class="main" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr
                            ...
                            <td class="alert alert-warning"
                                ...
                                هشدار ترافیک شما رو به اتمام است 
                            </td>
                        </tr>
                        <tr
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            شما <strong>80٪</strong> از ترافیک خود را استفاده کرده اید، لطفاً نسبت به تمدید ترافیک اقدام کنید تا باعث اختلال در استفاده نشود.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
