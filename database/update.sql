...
ALTER TABLE `v2_order`
ADD `surplus_order_ids` text NULL COMMENT 'Discounted orders' AFTER `balance_amount`;

ALTER TABLE `v2_order`
CHANGE `status` `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0To be paid 1Opening 2Cancelled 3Completed 4Discounted' AFTER `surplus_order_ids`;
...
ALTER TABLE `v2_server_trojan`
ADD `allow_insecure` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is it allowed to be unsafe' AFTER `server_port`,
CHANGE `show` `show` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Whether to display' AFTER `allow_insecure`;
...
CREATE TABLE `v2_stat_server` (
  ...
  `record_at` int(11) NOT NULL COMMENT 'Record time',
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `v2_stat_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_count` int(11) NOT NULL COMMENT 'Number of orders',
  `order_amount` int(11) NOT NULL COMMENT 'Total orders',
  `commission_count` int(11) NOT NULL,
  `commission_amount` int(11) NOT NULL COMMENT 'Total commission',
