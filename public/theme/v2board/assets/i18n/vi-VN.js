window.settings.i18n['vi-VN'] = {
  ...
  '当前剩余佣金': 'Tiền hoa hồng còn lại hiện tại',
  '三级分销比例': 'Tỷ lệ phân phối ba cấp',
  '累计获得佣金': 'Tích lũy nhận được hoa hồng',
  '您邀请的用户再次邀请用户将按照订单金额乘以分销等级的比例进行分成。': 'Người dùng mà bạn mời lại mời người dùng sẽ được chia sẻ theo tỷ lệ của cấp độ phân phối của đơn hàng.'
};
