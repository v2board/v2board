window.settings.i18n['fa-IR'] = {
  ...
  '已过期': 'منقضی شده',
  '已用 {used} / 总计 {total}': 'مصرف شده {used} / مجموع {total}',
  ...
  '您的信用卡信息只会被用作当次扣款，系统并不会保存，这是我们认为最安全的。': 'برای امنیت بیشتر شما، اطلاعات کارت اعتباری شما ذخیره نشده و فقط برای پرداخت فعلی مورد استفاده قرار می گیرد.',
  '订单总额': 'مجموع سفارش',
  '总计': 'مجموع',
  '结账': 'پرداخت',
  ...
  '已完成': 'تکمیل شد',
  '订单已支付并开通。': 'سفارش پرداخت شد و سرویس مورد نظر فعال شد.',
  '选择订阅': 'انتخاب اشتراک',
  ...
  '下单': 'ایجاد سفارش',
  '总计': 'مجموع',
  '变更订阅会导致当前订阅被新订阅覆盖，请注意。': 'لطفاً توجه داشته باشید، تغییر یک اشتراک باعث می‌شود که اشتراک جدید با اشتراک قبلی جایگزین شود.',
  '该订阅无法续费': 'این اشتراک قابل تمدید نیست',
  '选择其他订阅': 'اشتراک دیگری را انتخاب کنید',
  '我的钱包': 'کیف پول من',
  '账户余额(仅消费)': 'موجودی حساب (فقط خرج کردن)',
  '推广佣金(可提现)': 'کمیسیون (قابل برداشت)',
  '钱包组成部分': 'اجزای کیف پول',
  '划转': 'انتقال به موجودی',
  '推广佣金提现': 'برداشت کمیسیون',
  '修改密码': 'تغییر کلمه عبور',
  '保存': 'ذخیره کردن',
  '旧密码': 'رمز عبور قدیمی',
  '新密码': 'رمز عبور جدید',
  '请输入旧密码': ', رمز عبور مورد نیاز است',
  '请输入新密码': 'گذاشتن رمز عبور',
  '通知': 'اعلانات',
  ...
  '标签': 'برچسب‌ها',
  '状态': 'وضعیت',
  '节点五分钟内节点在线情况': 'وضعیت آنلاین بودن گره در پنج دقیقه گذشته',
  '倍率': 'ضریب',
  '使用的流量将乘以倍率进行扣除': 'حجم مصرف شده در ضریب ضرب شده و محاسبه می شود',
  '更多操作': 'اکشن های بیشتر',
  ...
  '实际下行': 'دانلود واقعی',
  '合计': 'کل ترافیک',
  '公式：(实际上行 + 实际下行) x 扣费倍率 = 扣除流量': 'فرمول : (آپلود + دانلود) * ضریب مصرف = ترافیک مصرف شده',
  '复制成功': 'با موفقیت نسخه برداری شد',
  '复制订阅地址': 'آدرس اشتراک را کپی کنید',
  '导入到': 'واردات در:',
  '一键订阅': 'اشتراک با یک کلیک',
  '复制订阅': 'اشتراک را کپی کنید',
  '推广佣金划转至余额': 'انتقال کمسیون به موجودی کیف پول',
  '确认': 'تأیید کردن',
  '划转后的余额仅用于{title}消费使用': 'موجودی منتقل شده فقط برای مصرف در {title} استفاده می شود',
  ...
  '申请提现': 'برداشت از کمسیون',
  '确认': 'تایید',
  '取消': 'انصراف',
  '提现方式': 'روش برداشت',
  '请选择提现方式': 'لطفاً یک روش برداشت را انتخاب کنید',
  '提现账号': 'مقدار برداشت',
  '请输入提现账号': 'لطفا مقدار برداشت را وارد کنید',
  '我知道了': 'می فهمم',
  '绑定Telegram': 'تلگرام را ببندید',
  '第一步': 'گام ۱',
  '第二步': 'گام ۲',
  ...
  '节点名称': 'نام گره',
  '于 {date} 到期，距离到期还有 {day} 天。': 'در تاریخ {date} منقضی می شود. {day} روز دیگر باقی مانده است',
  ...
  '流量明细仅保留近月数据以供查询。': 'فقط اطلاعات آخرین ماه استفاده را برای بررسی جزئیات نگه داری می کنیم',
  '扣费倍率': 'ضریب مصرف',
