...
class ServerXraySave extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'realitySettings' => 'nullable|array',
    ...
    public function messages()
    {
        return [
            ...
            'short_id.required' => 'short_id不能为空',
            'public_key.required' => 'public_key不能为空',
            'reality.required' => 'reality不能为空',
            'tags.array' => '标签格式不正确',
            ...
            'realitySettings.array' => 'reality配置有误',
